declare namespace wx {
    ...
    /**获取小游戏冷启动时的参数。 */
    export function getLaunchOptionsSync(): LaunchParams
    /**
     * 主动拉起转发，进入选择通讯录界面
     * @param object 参数
     */
    ...
    export class uma {
        /**关卡付费 */
        static revenue(object: object) { }
        /**自定义事件 */
        static trackEvent(eventId: string, params?: object) { }
        static stage = umaStage
        static level = umaLevel
    }
    ...
    class umaLevel {
        /**初始化上报 */
        static onInitLevel(object: object) { }
        /**升级 */
        static onSetLevel(object: object) { }
    }
     ...
     * }
     */
    export function setMessageToFriendQuery(object: object)
    /**
     ...
     * }
     */
    export function getPotentialFriendList(object: object)
    /**
     * 给指定的好友分享游戏信息
     * @param object { 
     * openId : string,  
     ...
     * }
     */
    export function shareMessageToFriend(object: object)
}
